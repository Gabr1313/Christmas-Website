function cHTML 
(Input, Out, Intro, Prefix, ImgType, QDir, QImgName, NBDir, NBImgName, MDir, MImgName, SHDir, SHImgName, RDir, RImgName) {
    ...
    this.Show1 = function() {
        ...
        td.innerHTML = "<h1 class='tit'>Quarantine</h1><h2 class='tit'><div>Click on the image, if you'd like to zoom<br>Click on the button at the right side to see the next table<div></h2>";
    ...
    this.Show2 = function() {
        ...
        td.innerHTML = "<h1 class='tit'>Nhak's birthday</h1><h2 class='tit'><div>Click on the image, if you'd like to zoom<br>Click on the buttons at the right side or the left side to see the previous or the next table<div></h2>";
    ...
    this.Show3 = function() {
        ...
        td = tr.insertCell(-1);
        td.colSpan = this.Cols + 2; td.align = "center"; //colSpan mi dice quante colonne occupa la mia cella 
        td.innerHTML = "<h1 class='tit'>Milano</h1><h2 class='tit'><div>Click on the image, if you'd like to zoom<br>Click on the buttons at the right side or the left side to see the previous or the next table<div></h2>";
    ...
    this.Show4 = function() {
        ...
        td = tr.insertCell(-1);
        td.colSpan = this.Cols + 2; td.align = "center"; //colSpan mi dice quante colonne occupa la mia cella 
        td.innerHTML = "<h1 class='tit'>Sea Holiday</h1><h2 class='tit'><div>Click on the image, if you'd like to zoom<br>Click on the buttons at the right side or the left side to see the previous or the next table<div></h2>";
    ...
    this.Show5 = function() {
        ...
        td = tr.insertCell(-1);
        td.colSpan = this.Cols + 1; td.align = "center"; //colSpan mi dice quante colonne occupa la mia cella 
        td.innerHTML = "<h1 class='tit'>Random</h1><h2 class='tit'><div>Click on the image, if you'd like to zoom<br>Click on the button at the left side to see the previous table<div></h2>";
